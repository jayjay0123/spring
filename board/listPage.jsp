...
<div class="center2 d-flex justify-content-between">
		<div class="Review">					
			<b>타인의 취향</b>				
		</div>
		<c:if test ="${member!= null}">
		<div class="nav-item d-flex mx-3">
              <button class="nav-link btn write mx-5" onclick="location.href='${path}/board/write'">글쓰기</button>
           </div>
           </c:if>
           <c:if test ="${member == null }">
...
<div class="col-md-12 view">
    ...
    <div class="d-flex justify-content-end my-5">
    	<div class="btn-group nav-item">
    		<input type="button" value="글쓰기" class="nav-link btn write" onclick="location.href='${path}/board/write'" />
    	</div>
    </div>     
