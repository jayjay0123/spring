    ...
    <div class="offcanvas-body">
		...
		<div class="input-group my-5">
			<form class="search_wrap d-flex" >
				<input type="text" placeholder="Search" name="keyword" value="${page.keyword}" class="form-control"/>
				<input type="submit" value="검색" class="btn btn-primary sButton" id="searchBtn"/>
			</form>
		</div>
		<p>최근 검색어</p>
		<p>추천 검색어</p>
		<div class="d-flex">
			<a class="recom" href="${path}/board/photo?keyword=단정">단정</a>
			<a class="recom"  href="${path}/board/photo?keyword=깔끔">깔끔</a>
			<a class="recom"  href="${path}/board/photo?keyword=예쁜">예쁜</a>
		</div>
    </div>
</div>
<script>
document.getElementById("searchBtn").onclick = function(){
		...
		location.href="${path}/board/photo?num=1"+"&keyword="+keyword;
}
</script>
