...
public class BoardController {
	...
	//list + 페이징 추가
	@GetMapping("/photo") 
	public void getListPage(Model model, @RequestParam(value="num",required=false, defaultValue="1") int num, 
			@RequestParam(value="keyword",required=false, defaultValue="") String keyword) throws Exception{ //매개변수num은 페이지 번호
		logger.info("get photo list");
